...
<div class="product-container row g-0">
    ...
    <div class="col-md-6 product-info">
        ...
        <div class="d-grid gap-2 mt-4">
            <button class="btn btn-cart" onclick="addToCart(${product.productNo})">장바구니 담기</button>
            <button class="btn btn-buy" onclick="buyNow(${product.productNo})">바로 구매하기</button>
        </div>
    </div>
</div>
...
function addToCart(productNo) {
    ...
    const quantity = 1;
    const memberNo = '${loginMember.memberNo}'; // 세션에서 로그인 정보 가져오기
    const isChecked = 'N'; // 기본값
